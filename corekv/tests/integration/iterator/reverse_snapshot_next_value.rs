...
fn test_reverse_snapshot_next_value<D, S>(mut state: State<D, S>) -> State<D, S>
where
...
fn test_reverse_snapshot_next_value_with_concurrent_addition<D, S>(
    mut state: State<D, S>,
) -> State<D, S>
where
    D: Db<Snapshot = S, Iter = S::Iter>,
...
fn test_reverse_snapshot_next_value_with_concurrent_update<D, S>(
    mut state: State<D, S>,
) -> State<D, S>
where
    D: Db<Snapshot = S, Iter = S::Iter>,
...
tests!(test_reverse_snapshot_next_value: db);
tests!(test_reverse_snapshot_next_value_with_concurrent_addition: db);
tests!(test_reverse_snapshot_next_value_with_concurrent_update: db);
